# Nova Launcher (iOS)
[![Development build](https://github.com/xalor-ops/NovaLauncher/actions/workflows/development.yml/badge.svg?branch=main)](https://github.com/AngelAuraMC/Amethyst-iOS/actions/workflows/development.yml)
